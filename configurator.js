...
class Configurator {
    ...
    showPrice() {
        ...
        if (this.isDiscount()) {
            $('#price-discount').show();
            $('#price-discount').text(configurator.numberWithSpaces(this.getPriceWithDiscount()) + ' DKK*');
    ...
    loadSummary() {
        ...
        str += '<h3 class="blue-text ' + (this.isDiscount() ? 'line-through' : '') + '">' + this.numberWithSpaces(this.getPrice()) + ' DKK</h3>';
        if (this.isDiscount()) {
            str += '<h2 class="red-text">' + this.numberWithSpaces(this.getPriceWithDiscount()) + ' DKK</h2>';
        }
    ...
    getPriceDiv(mainNode, priceNode, tNode) {
        ...
        return '<div class="col-sm-3 col-xs-5 text-right "><span class="' + classDiscount + '">'
            + this.numberWithSpaces(stepPrice) + '</span>' + stepPriceDiscount + ' DKK*</div>';
    }
    ...
    printSummary() {
        ...
        this.allSteps.forEach(step => {
            ...
            if (step.selectedNodes[1] !== undefined && priceNode.price.g1 !== 0) {
                bodyData.push([
                    ...
                    {
                        text: (priceNode.price.g1 === -1 ? '' : this.numberWithSpaces(this.getStepPrice(step.selectedNodes[3], priceNode)) + ' DKK'),
        ...
        bodyData.push([
            ...
            '',
            {
                text: this.numberWithSpaces(this.getPrice()) + ' DKK',
